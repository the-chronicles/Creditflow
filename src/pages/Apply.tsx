...
const loanSchema = z.object({
  ...
  paymentFrequency: z
    .string()
    .min(1, { message: "Please select payment frequency" }),
  installments: z
    .string()
    .min(1, { message: "Please select number of installments" }),
  purpose: z
    .string()
    .min(3, { message: "Please provide the purpose of the loan" })
    .max(500),
  employment: z
    .string()
  ...
  payFrequency: z
    .string()
    .min(1, { message: "Please select your pay frequency" }),
  nextPayDate: z.date({
  ...
  accountType: z
    .string()
    .min(1, { message: "Please select account type" })
    .optional(),
  routingNumber: z
    .string()
...
const Apply = () => {
  ...
  useEffect(() => {
    fetchLoanProducts()
      ...
      .catch((err) => console.error("Failed to load loan products", err));
  }, []);
    ...
    if (videoRef.current && canvasRef.current) {
      ...
      if (ctx) {
        ...
        canvas.toBlob(
          (blob) => {
            if (blob) {
              const file = new File([blob], "id-document.jpg", {
                type: "image/jpeg",
              });
              setIdFile(file);
              ...
              toast({
                ...
                description:
                  "Your ID document photo has been captured successfully.",
              });
            }
          },
          "image/jpeg",
  ...
  const onSubmit = async (data: LoanFormValues) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "We'll review your loan application and get back to you shortly.",
      });
      navigate("/dashboard");
    } catch (error) {
          ...
          <Card className="w-full max-w-md">
            <CardHeader className="text-center">
              ...
              <CardDescription className="mt-2">
                We're sorry, but direct deposit is required for loan
                applications. Without direct deposit, we cannot process your
      ...
      <Layout>
        <div className="max-w-3xl mx-auto animate-fade-in">
          ...
          <p className="text-muted-foreground mb-6">
            Position your ID document in the frame and take a photo
          </p>
      ...
      <div className="max-w-3xl mx-auto animate-fade-in">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Provide the details for your loan request
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
              ...
              >
                      ...
                      <FormItem>
                        ...
                        {selectedProduct && (
                          <div className="text-sm text-muted-foreground mt-2">
                            ...
                            Amount range: ${selectedProduct.minAmount} – $
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Loan Amount: $
                          {parseInt(field.value || "0").toLocaleString()}
                        </FormLabel>
                        <FormControl>
                          <div className="space-y-4">
                            <Slider
                ...
                <div className="p-4 bg-muted rounded-md space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <div className="font-medium text-right">
                      {currentPaymentFrequency === "weekly"
                        ? "Weekly"
                        : "Monthly"}
                    </div>
                    ...
                    <div className="font-medium text-right">
                      ...
                      {paymentAmount && installments
                        ? (paymentAmount * installments).toFixed(2)
                        : "0.00"}
                    </div>
                  </div>
                </div>
