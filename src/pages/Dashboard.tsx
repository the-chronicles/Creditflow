...
// const totalOutstanding = loans.activeLoans?.reduce(
//   (total, loan) => total + (loan.remainingAmount || 0),
//   0
// ) || 0;

// const nextPaymentTotal = loans.activeLoans?.reduce(
...
//     ? `Due on ${new Date(loans.activeLoans[0].nextPayment).toLocaleDateString()}`
